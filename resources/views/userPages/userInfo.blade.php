            ...
            <fieldset>
                ...
                <div id="s1">
                    ...
                    <div class="form-group text-center">
                        <img src="{{ URL::to('/') }}/public/storage/{{ ($user->pic) }}"  class="rounded-circle" style="width: 100px;height: 100px">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputcity1">User Picture</label>
                        <div class="input-group mb-3">
                            <div class="custom-file">
                                <input value="{{ $user->pic }}" type="file" name="pic" id="pic" class="custom-file-input" >
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $user->name }}" type="text" name="name" class="form-control" id="name" placeholder="Enter name"> </div>

                         {{-- address **************************** --}}
                    <div class="form-group">
                        <label for="address">address</label>
                        <input value="{{ $user->address }}" type="text" name="address" class="form-control" id="address" placeholder="Enter address"> </div>
                    {{-- birth **************************** --}}
                    <div class="form-group">
                ...
                <div id="s3">
                    ...
                    <div class="form-group ">
                        ...
                        <input value="" type="password" class="form-control" id="rePassword" placeholder="re Password">
                    </div>
...
<script>
    $(document).ready(function () {
        ...
        function getlist(urlPara, selectorId, idPara, namePara) {
            ...
            xhttp.open("GET", urlApi+urlPara, true);
            xhttp.send();
