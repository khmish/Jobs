        ...
        <table class="table table-light table-hover">
            ...
            <tbody>
                @foreach($qualifications as $qualification)
                    ...
                    <tr id="{{ $qualification->id }}" class="">
                        <th scope="row">{{ $qualification->id }}</th>
                        <td>{{ $qualification->qualificationTitle }}</td>
                        <td>

                            <button type="button" class="btn btn-primary" id="edit" onclick="onedit('{{ $qualification->id }}')"
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        <label for="qualificationTitle">Title</label>
                        <input type="text" class="form-control" id="qualificationTitle">
                    </div>
                </form>
            </div>
...
<script>
    ...
    function onedit(parId)
    {
        ...
        $('#sAdd').hide();
        $('#sEdit').show();
        document.getElementById('qualificationTitle').value=(document.getElementById(parId).children[1].innerHTML);
